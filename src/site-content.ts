...
export const defaultSiteContent: SiteContent = {
  ...
  gallery: {
    ...
    items: [
      ...
      {
        title: "Chemical Storage Lab",
        url: "/site-images/labpic6.png",
      },
      {
        title: "Lab Access Corridor",
        url: "/site-images/labpic7.png",
      },
      {
        title: "Containment Cell Block",
        url: "/site-images/labpic8.png",
      },
      {
        title: "Locker Service Hall",
        url: "/site-images/LabPic9.png",
      },
      {
        title: "Restricted Door",
    ...
    items: [
      {
        ...
        description: "Play from the survivor's point of view as the facility closes in around you.",
      },
      {
        title: "Stalking AI Villain",
        description: "A major threat can chase, catch, and pressure you while you search for a way out.",
      },
      {
      ...
      },
      {
        ...
        description: "Rooms, locked doors, equipment, and evidence help explain what happened in the facility.",
      },
      {
      ...
      },
      {
        ...
        description: "Unreal Engine 5 is used to build the lighting, materials, and oppressive facility spaces.",
      },
    ],
  },
  download: {
